    ...
    return Column(
      ...
      children: [
        Text(kicker.toUpperCase(),
            style: const TextStyle(color: AppColors.saffron, fontSize: 11, letterSpacing: 2.4, fontWeight: FontWeight.w600)),
...
class GlassCard extends StatelessWidget {
  ...
  const GlassCard({super.key, required this.child, this.accent = AppColors.gold, this.padding = const EdgeInsets.all(18), this.onTap});
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(height: 3, decoration: BoxDecoration(color: accent, borderRadius: const BorderRadius.vertical(top: Radius.circular(16)))),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(width: 6),
        Text('LIVE', style: TextStyle(color: AppColors.green, fontSize: 9, letterSpacing: 1.4, fontWeight: FontWeight.w700)),
      ]),
    );
  }
}
