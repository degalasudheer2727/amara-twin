      ...
      const SliverToBoxAdapter(
        child: Padding(
          ...
          child: SectionHeader(
            ...
            subtitle:
                'Governed, refreshable feeds with a defined schema, owner and cadence — the API surface of the twin.',
          ),
        ),
      ),
      SliverPadding(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
              spacing: 6,
              runSpacing: 6,
              children: c.feeds.map((f) => Tag(f)).toList()),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
          ...
          children: [
            ...
            const Text('FEEDS',
                style: TextStyle(
                    color: AppColors.muted2, fontSize: 11, letterSpacing: 1.6)),
            ...
            const Text('Indicative concept data — not an official feed.',
